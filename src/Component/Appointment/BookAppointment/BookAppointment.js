...
const BookAppointment = ({date}) => {
    return (
        <div className='divmargin'>
           <h2 className='text-center text-style color'>Available Appointment : {moment(date).format("MMMM Do YYYY")}{" "}</h2>

        <div className='d-flex justify-content-center mt-5'>
             <div className='row w-75'>
             {
                 bookingData.map(data=><BookingCard data={data} date={date}></BookingCard>)
             }
